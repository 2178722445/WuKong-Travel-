...
> **AI 辅助声明**：本项目的部分代码（包括 UI 布局、高德 API 集成、部分后端逻辑）由 AI 编程助手辅助生成，本人负责需求设计、代码审查、调试优化和功能整合。项目中的核心 GIS 知识（坐标系、缓冲区分析、路径规划等）和全栈架构设计均由本人独立学习掌握。
...
│ └────────────┘  └─────────────────────────┘              │
│ ┌──分析工具──────────────────────────────────────┐       │
│ │ 🌤 实时天气  ☁ 多云 18° 风向:北 湿度:45%       │       │
│ │ 🗺 路径规划  起点:太原 → 终点:五台山  180km     │       │
│ │ 🎯 缓冲区    中心:五台山 | 半径:5km | POI:停车场 │       │
│ └────────────────────────────────────────────────┘       │
│                     [图例]  ●取景地  ●收藏  ●缓冲区        │
└──────────────────────────────────────────────────────────┘
```
